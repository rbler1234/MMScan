...
class MMScanPointCloud3DGroundingDataset(BaseDataset):
    ...
    def __init__(self,
        ...
        self.mmscan_loader = MMScan(version='v1', split='val' if test_mode else 'train',
                                    task='MMScan-VG',ratio=0.1)
    ...
    def process_metainfo(self):
        ...
        # val to match the index of the key
    ...
    def load_data_list(self) -> List[dict]:
        ...
        annotations = load(self.mmscan_loader.get_possess('es_file',''))
    ...
    def load_language_data(self):
        ...
        language_annotations = self.mmscan_loader.samples
        ...
        for anno in mmengine.track_iter_progress(language_annotations):
            ...
            language_info['pc_file'] = self.mmscan_loader.get_possess('pc_file',language_info['scan_id'])
    ...
    def parse_ann_info(self, info: dict) -> dict:
        ...
        # change some now from the base pkl
        name_mapping = {
