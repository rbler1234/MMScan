    ...
    def forward(self, data_dict):
        ...
        if 'obj_tokens' not in data_dict:
            ...
            try:
                ...
                torch.save(self.state_dict(),"/mnt/petrelfs/linjingli/tmp/data/big_tmp/model_dict_1028.pth")
                torch.save(data_dict,"/mnt/petrelfs/linjingli/tmp/data/big_tmp/debug_leo_1028.pt")
                import IPython; 
                IPython.embed()
