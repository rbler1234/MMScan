...
class ScanNetBaseDataset(Dataset):
    ...
    def _get_scan_data(self, scan_name, input_bbox =None):
        ...
        instance_bboxes = [np.array(self.embodied_scan_box_info[scan_name][obj_id]["bbox"]) for obj_id in self.embodied_scan_box_info[scan_name]]
        instance_bboxes = [self.MMScan_loader.down_9DOF_to_6DOF(pcd_data,instance_bbox) for instance_bbox in instance_bboxes]
