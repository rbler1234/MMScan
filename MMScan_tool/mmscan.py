...
class EmbodiedScan(Dataset):
    ...
    Database class for MMScan to help query and retrieve information from the database.
        ...
        Args:
            ...
            dataroot (str): The root path of the database. It depends on where you
