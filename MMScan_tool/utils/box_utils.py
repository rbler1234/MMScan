...
def euler_iou3d_bbox(center1, size1, rot1, center2, size2, rot2):
    ...
    Args:
        ...
        size1 (Tensor): (l, w, h) of box1.
        rot1 (Tensor): rot matrix of box1.
        center1 (Tensor): (cx, cy, cz) of box2.
        size1 (Tensor): (l, w, h) of box2.
        rot1 (Tensor): rot matrix of box2.
    ...
    return euler_iou3d_corners(corners1, corners2).cpu().numpy()