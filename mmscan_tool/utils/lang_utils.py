...
def QA_prompt_define():
    ...
    ex_instance = 'The input is: { "Question" : "What is the function of this object?", "Model Answer" : '+\
    ...
    ex_instance += 'The input is: { "Question" : "What is the placement of this object?", "Model Answer" : "It is '+\
    ...
    ex_instance += 'The input is { "Question" : "Please compare these two objects closely, are they similar in '+\
...
if __name__ == '__main__':
    all_pred ={"1":['Yes'],"2":['Belonging to the category of furniture, they are collectively']}
    all_gt = {
        "1":['Yes','Yes,it is.'],
