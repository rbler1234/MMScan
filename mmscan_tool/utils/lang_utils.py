...
if __name__ == "__main__":
    all_pred = {
        "1": ["Yes"],
        "2": ["Belonging to the category of furniture, they are collectively"],
    }
    all_gt = {
        "1": ["Yes", "Yes,it is."],
        "2": [
            "These <object 47> and <table 29> together form a functional combination for learning or working"
        ],
    }
    refine_EM_result = []
