...
def process_mp3d(new_scan_id,data_root,axis_align_matrix_dict,mapping):
    ...
    scan_id,region_id = new_scan_id.split('_region')[0],'region'+new_scan_id.split('_region')[1]
    a = PlyData.read(f'{data_root}/{mapping[scan_id]}/region_segmentations/{region_id}.ply')
