...
def process_scannet(scan_id,data_root,scannet_matrix):
    ...
    scan_ply_path = os.path.join(f'{data_root}/scans', scan_id, scan_id + '_vh_clean_2.labels.ply')
    data_color = PlyData.read(os.path.join(f'{data_root}/scans', scan_id, scan_id + '_vh_clean_2.ply'))
